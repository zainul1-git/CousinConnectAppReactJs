...
const getImageUrl = (url) => {
  ...
  const baseUrl = (import.meta.env.VITE_API_BASE_URL || 'https://localhost:7168').replace(/\/api\/?$/, '');
...
export default function Profile() {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-brand-100 shadow-sm p-6">
        <div className="flex justify-center mb-6">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-brand-400 to-brand-700 flex items-center justify-center text-white font-bold text-3xl overflow-hidden">
            {profile.avatarUrl ? (
