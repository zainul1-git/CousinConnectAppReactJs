...
export default function Leaderboard() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-brand-100 divide-y divide-gray-100 shadow-sm">
        {entries.map((entry) => (
          <div key={entry.userId} className="flex items-center gap-4 px-5 py-4">
            ...
            <span className="text-brand-600 font-semibold">{entry.points} pts</span>
          </div>
        ))}
      </div>
    </div>
